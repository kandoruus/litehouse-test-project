...
`;var g;class D extends HTMLElement{constructor(e,s,n){super();b(this,g,this.attachShadow({mode:"open"}));o(this,"title");o(this,"description");o(this,"imgUrl");this.title=e,this.description=s,this.imgUrl=n,this.connectedCallBack()}connectedCallBack(){l(this,g).innerHTML=`
